...
c20   FORMAT(6X,'In above message,  I1 =',I10)
c     IF (NI .EQ. 2) WRITE (LUNIT, 30) I1,I2
c30   FORMAT(6X,'In above message,  I1 =',I10,3X,'I2 =',I10)
c     IF (NR .EQ. 1) WRITE (LUNIT, 40) R1
c40   FORMAT(6X,'In above message,  R1 =',D21.13)
c     IF (NR .EQ. 2) WRITE (LUNIT, 50) R1,R2
c50   FORMAT(6X,'In above,  R1 =',D21.13,3X,'R2 =',D21.13)
C
