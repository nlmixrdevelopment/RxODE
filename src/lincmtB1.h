...
double rx8=(*t)*rx4;
double rx17=rx8*(rx7);
double rx18=rx4*(-(*ka)*A1lastka-A1last);
A1ka=-(*r1)/rx5+rx15/rx5-rx18/(*ka)+rx17/(*ka);
double rx0=(*r1)+(*r2);
double rx1=(*r1)*(*ka);
double rx2=(*ka)*(*k20);
...
double rx10=(((*k20))*((*k20)));
double rx11=rx2*A1last;
double rx12=rx1+rx9;
double rx13=rx10*A2last;
double rx14=rx2-rx10;
A2=(*b2)+(rx0)/(*k20)-(rx12+rx6*(-A2last+rx13-rx11))/(rx14)+rx15/(-(*k20)+(*ka));
double rx16=(((-(*k20)+(*ka)))*((-(*k20)+(*ka))));
double rx19=rx13-rx11;
double rx20=rx19-A2last;
double rx22=rx15/rx16;
double rx23=rx6*(rx20);
double rx24=rx12+rx23;
A2ka=-(rx0+rx6*(-(*k20)*A1last+rx10*A2lastka-rx2*A1lastka-A2lastka))/(rx14)+(*k20)*(rx24)/(((rx14))*((rx14)))-rx22+rx18/(-(*k20)+(*ka))-rx17/(-(*k20)+(*ka));
A2k20=-(rx0)/rx10-(-(*r2)+rx6*(2*(*k20)*A2last+rx10*A2lastk20-rx3-rx2*0-A2lastk20)-(*t)*rx6*(rx20))/(rx14)+(-2*(*k20)+(*ka))*(rx24)/(((rx14))*((rx14)))+rx22-rx4*(*ka)*0/(-(*k20)+(*ka));
#undef A1ka
#undef A2ka
#undef A2k20
#undef A1lastka
