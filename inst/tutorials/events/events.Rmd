...
### Exercise: Create an empty table using `eventTable()` and add a 100 mg dose
...
ev <- et(amount.units="mg", time.units="hr") %>% 
    et(dose=5000, ii=15, dosing.interval=12, until=48) %>%
...
### Pulling it all together - solving the system
