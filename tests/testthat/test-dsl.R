rxPermissive(
  {
    ...
    test_that("d/dt(x) parsing", {
      ...
      expect_equal(rxToSE(d/dt(E)), "rx__d_dt_rx_SymPy_Res_E__")
      expect_equal(rxFromSE("rx__d_dt_rx_SymPy_Res_E__"), "d/dt(E)")
      tmp <- symengine::Symbol("rx__d_dt_rx_SymPy_Res_E__")
