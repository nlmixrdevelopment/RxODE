rxPermissive({
    ...
    test_that("v1 rate constants", {
        ...
        expect_equal(p1,
                     structure(list(vc = 8, kel = 0.5, vss = 8, cl = 4, t12alpha = 1.39,
        ...
        expect_equal(p1, structure(list(vc = 10, kel = 0.3, k12 = 0.2, k21 = 0.02, k13 = 0.1,
                                        ...
                                        fracC = 0.000647), class = "data.frame",
                                   row.names = c(NA, -1L)))
    })
    ...
    test_that("Volumes and clearances", {
        ...
        expect_equal(p1, structure(list(vc = 8, kel = 0.5, vss = 8, cl = 4, t12alpha = 1.39,
                                        alpha = 0.5, A = 0.125, fracA = 1), class = "data.frame",
                                   row.names = c(NA, -1L)))

        p1 <- rxDerived(v1=5.0, v2=50, cl=3.5, q=2.5, digits=3)

        expect_equal(p1, structure(list(vc = 5, kel = 0.7, k12 = 0.5, k21 = 0.05, vp = 50,
                                        vss = 55, cl = 3.5, q = 2.5, t12alpha = 0.568, t12beta = 24.2,
                                        alpha = 1.22, beta = 0.0287, A = 0.196, B = 0.00358, fracA = 0.982,
                                        fracB = 0.0179), class = "data.frame",
                                   row.names = c(NA, -1L)) )

        p1 <- rxDerived(v1=10, v2=100, v3=1000,
