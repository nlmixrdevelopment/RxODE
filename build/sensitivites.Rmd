...
# Two compartment Senstivities

## Two compartment oral steady state r1

```{r}
getFun("twoCmtKaRateSSr1")
```

## Two compartment oral steady state r2

```{r}
getFun("twoCmtKaRateSSr2")
```

## Two compartment oral steady state r1 tau
```{r}
getFun("twoCmtKaRateSStr1")
```