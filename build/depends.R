...
A3last=r2*k23/(beta*alpha) - exp(-tinf*alpha)*r2*(-k23*alpha + ka*k23)/(-beta*alpha^2.0 + ka*(beta*alpha - alpha^2.0) + alpha^3.0) + exp(-tinf*beta)*r2*(-k23*beta + ka*k23)/(beta^2.0*alpha + ka*(-beta*alpha + beta^2.0) - beta^3.0)
  ...
  m <- RxODE({
    A1last=r1/ka - exp(-tinf*ka)*r1/ka
A2last=-exp(-tinf*ka)*r1*(k42*k32 + (-k32 - k42)*ka + ka^2.0)/(ka^2.0*lam1 + lam2*(-ka*lam1 + ka^2.0) + lam3*(-ka*lam1 + lam2*(-ka + lam1) + ka^2.0) - ka^3.0) - exp(-tinf*lam1)*r1*(-ka*lam1^2.0 - ka*k42*k32 + (k32 + k42)*ka*lam1)/(-ka*lam1^3.0 + lam2*(ka*lam1^2.0 - lam1^3.0) + lam3*(ka*lam1^2.0 + lam2*(-ka*lam1 + lam1^2.0) - lam1^3.0) + lam1^4.0) + exp(-tinf*lam2)*r1*(-ka*lam2^2.0 - ka*k42*k32 + (k32 + k42)*ka*lam2)/(lam2^3.0*(ka + lam1) + lam3*(lam2^2.0*(-ka - lam1) + ka*lam2*lam1 + lam2^3.0) - ka*lam2^2.0*lam1 - lam2^4.0) - exp(-tinf*lam3)*r1*(-ka*lam3^2.0 - ka*k42*k32 + (k32 + k42)*ka*lam3)/(lam3^2.0*(ka*lam1 + lam2*(ka + lam1)) + (-ka - lam1 - lam2)*lam3^3.0 - ka*lam2*lam1*lam3 + lam3^4.0) + r1*k42*k32/(lam2*lam1*lam3)
A3last=exp(-tinf*ka)*r1*(-k42*k23 + ka*k23)/(ka^2.0*lam1 + lam2*(-ka*lam1 + ka^2.0) + lam3*(-ka*lam1 + lam2*(-ka + lam1) + ka^2.0) - ka^3.0) + exp(-tinf*lam1)*r1*(-ka*k23*lam1 + ka*k42*k23)/(-ka*lam1^3.0 + lam2*(ka*lam1^2.0 - lam1^3.0) + lam3*(ka*lam1^2.0 + lam2*(-ka*lam1 + lam1^2.0) - lam1^3.0) + lam1^4.0) - exp(-tinf*lam2)*r1*(-ka*k23*lam2 + ka*k42*k23)/(lam2^3.0*(ka + lam1) + lam3*(lam2^2.0*(-ka - lam1) + ka*lam2*lam1 + lam2^3.0) - ka*lam2^2.0*lam1 - lam2^4.0) + exp(-tinf*lam3)*r1*(-ka*k23*lam3 + ka*k42*k23)/(lam3^2.0*(ka*lam1 + lam2*(ka + lam1)) + (-ka - lam1 - lam2)*lam3^3.0 - ka*lam2*lam1*lam3 + lam3^4.0) + r1*k42*k23/(lam2*lam1*lam3)
    A4last=exp(-tinf*ka)*r1*(-k24*k32 + ka*k24)/(ka^2.0*lam1 + lam2*(-ka*lam1 + ka^2.0) + lam3*(-ka*lam1 + lam2*(-ka + lam1) + ka^2.0) - ka^3.0) + exp(-tinf*lam1)*r1*(ka*k24*k32 - ka*k24*lam1)/(-ka*lam1^3.0 + lam2*(ka*lam1^2.0 - lam1^3.0) + lam3*(ka*lam1^2.0 + lam2*(-ka*lam1 + lam1^2.0) - lam1^3.0) + lam1^4.0) - exp(-tinf*lam2)*r1*(ka*k24*k32 - ka*k24*lam2)/(lam2^3.0*(ka + lam1) + lam3*(lam2^2.0*(-ka - lam1) + ka*lam2*lam1 + lam2^3.0) - ka*lam2^2.0*lam1 - lam2^4.0) + exp(-tinf*lam3)*r1*(ka*k24*k32 - ka*k24*lam3)/(lam3^2.0*(ka*lam1 + lam2*(ka + lam1)) + (-ka - lam1 - lam2)*lam3^3.0 - ka*lam2*lam1*lam3 + lam3^4.0) + r1*k24*k32/(lam2*lam1*lam3)
    B = A3last*k32+A4last*k42
    C = E4*A3last*k32+E3*A4last*k42
    I = A2last*k23*E4-A3last*k24*k42+A4last*k23*k42
    J = A2last*k24*E3+A3last*k24*k32-A4last*k23*k32
