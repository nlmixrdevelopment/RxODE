...
foceiSetup_ <- function(obj, data, theta, rxInv, epsilon = NULL, maxInnerEvals = 100L, nsim = NULL, printInner = FALSE) {
    .Call(`_RxODE_foceiSetup_`, obj, data, theta, rxInv, epsilon, maxInnerEvals, nsim, printInner)
}
