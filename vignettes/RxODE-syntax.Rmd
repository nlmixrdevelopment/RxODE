...
math libraries (e.g., `fabs`, `exp`, `log`, `sin`).  In addition, the
factorial operator (`!`) can be used. Notice that the modulo operator
`%` is currently unsupported.

You may also access the R's functions in the [R math libraries](https://cran.r-project.org/doc/manuals/r-release/R-exts.html#Numerical-analysis-subroutines),
