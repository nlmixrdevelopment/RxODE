...
if (file.exists(system.file("sim-var-sim.rds", package = "RxODE"))){
    ...
    save(sim, file = file.path(system.file(package = "RxODE"), "sim-var-sim.rds"), version = 2)
}
```
...
if (file.exists("sim-var-s.rds")){
    ...
    save(s, file = file.path(system.file(package = "RxODE"), "sim-var-s.rds"), version = 2)
}
...
if (file.exists(system.file("sim-var-s1.rds", package = "RxODE"))){
    ...
    save(s, file = file.path(system.file(package = "RxODE"), "sim-var-s1.rds"), version = 2);
}
...
if (file.exists(system.file("sim-var-s2.rds", package = "RxODE"))){
    ...
    save(sim, s, file = file.path(system.file(package = "RxODE"), "sim-var-s2.rds"), version = 2);
}
plot(s)
```
...
if (file.exists(system.file("sim-var-s3.rds", package = "RxODE"))){
    ...
    s <-sim %>% confint(c("centr", "eff"))
    save(sim, s, file = file.path(system.file(package = "RxODE"), "sim-var-s3.rds"), version = 2);
...
if (file.exists(system.file("sim-var-s4.rds", package = "RxODE"))){
    ...
    save(sim, s, file = file.path(system.file(package = "RxODE"), "sim-var-s4.rds"), version = 2)
}
