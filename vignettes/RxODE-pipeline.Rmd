...
## time.
if (file.exists(system.file("pipeline-sim0.rds", package = "RxODE"))){
    load(system.file("pipeline-sim0.rds", package = "RxODE"));
} else {
    ...
    save(sim0,file=file.path(system.file(package = "RxODE"), "pipeline-sim0.rds"))
}
...
```{r}
if (file.exists(system.file("pipeline-sim2.rds", package = "RxODE"))){
    load(system.file("pipeline-sim2.rds", package = "RxODE"));
} else {
    library(dplyr)
    ...
    save(sim2, file = file.path(system.file(package = "RxODE"), "pipeline-sim2.rds"))
}
