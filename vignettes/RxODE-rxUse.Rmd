...
vignette: >
  %\VignetteIndexEntry{RxODE in Packages}
...
use_package("RxODE", "Depends") ## Imports RxODE on load; Can use imports instead.
use_roxygen_md()
##use_readme_md()
library(RxODE);
## Now Create a model
...
directory.  Also a version of the code is included in the
automatically generated documentation object.  (Once created these
