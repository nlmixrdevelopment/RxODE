...
- EVID = 101, 102, 103,... These corresponds to the 1, 2, 3, ... modeled time (mtime).

These can only be accessed when solving with the option
`addDosing=TRUE`. If you want to see the classic `EVID` equivalents
you can use `addDosing=NA`.
...
dosing time and the highest dosing time.
