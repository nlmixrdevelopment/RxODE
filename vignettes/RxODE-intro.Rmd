...
Now that you have learned the basics of RxODE, there are a few things
you may wish to explore:

- [Simulating in a pipeline](RxODE-pipeline.html) (tidyverse style of simulation/updating)
- [Dynamic RxODE solved datasets](RxODE-data-frame.html)
- Multiple-subject simulations (with and without variability)
- Simulation from already existing data
